...
RULES = [
    (r"^микс",                     ("микс", "Микс")),
    (r"^пак\s*чой\s*(крас|red)",   ("пакчой_крас", "Пак чой красный")),
    (r"^пак\s*чой",                ("пакчой_зел", "Пак чой зеленый")),
    (r"^мизуна\s*(зел)",           ("мизуна_зел", "Мизуна зелёная")),
    (r"^мизуна",                   ("мизуна_крас", "Мизуна красная")),
    (r"^мангольд\s*(зел)",         ("мангольд_зел", "Мангольд зелёный")),
    (r"^мангольд\s*(борд)",        ("мангольд_борд", "Мангольд бордо")),
