...
# порог 0 = берём всех должников (мелкие тоже). ★23.09.2026: клиенты уволенной
# Абрамовой переведены в СПРАВОЧНИКЕ на Алёну — её строка больше не встречается,
# а порог Алёны поднят с 6 000 до 8 000 (решение Анны: список стал вдвое длиннее).
TASK_ROUTE = {
    "Ксения Наныкина":  ("Ксения Наныкина", 20, 0),
    "Дарья Вольнова":   ("Дарья Вольнова", 15, 0),
    "Алена Черкашина":  ("Алена Черкашина", 11, 8000),
}
