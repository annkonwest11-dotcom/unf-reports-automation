...
# Лианны и Абрамовой (2026-07-11); диапазоны покрывают ровно строки сотрудников.
...
class SheetsClient:
    ...
    def archive_month(self) -> str:
        ...
        # удаления Лианны и Абрамовой (2026-07-11). Формулы НЕ трогаем:
        ...
        manual_ranges = [
            ...
            'E83', 'E88', 'E92',  # РОП: факты (новые продажи / оборот / поступления)
            'E96:E97',            # РОП: доп.премия, комментарий
            'E106',               # Влада: % контента
            'E109:F112',          # Влада: найм (кол-во + ФИО)
            'E115',               # Влада: премия за проекты
