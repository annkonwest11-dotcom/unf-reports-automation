...
KPI_MANAGERS = {
    ...
    # Лилия Сулименко — менеджер поиска с августа 2026. Колонку «Менеджер Лилия»
    # в KPI-таблице заводит Анна; пока её нет, строка просто не встречается.
    "менеджер лилия": ("Лилия Сулименко", "поиск"),
    # Стажёры-менеджеры поиска с 01.09.2026. Колонки «Менеджер София» /
    # «Менеджер Виолетта» в KPI-таблице заводит Анна; пока их нет — строки
    # просто не встречаются, как было с Лилией в августе.
    "менеджер софия": ("София Хакимова", "поиск"),
    "менеджер виолетта": ("Виолетта Караханова", "поиск"),
